<template>
    <div 
        ...
        <div class="entry-description">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dicta unde culpa modi quas ab minima dolorem ducimus id, enim quibusdam. Quia commodi deserunt doloribus aperiam impedit, culpa vel? Iure, cum!
        </div>
    </div>
</template>
